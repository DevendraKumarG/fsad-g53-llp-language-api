...
using Llp.Language.Repositories;
using Llp.Language.Repositories.Contracts;
using Llp.Language.Middleware;
using Llp.Language.Services;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.IdentityModel.Tokens;
using System.Text;
using Llp.Language.Controllers;
...
{
    opt.SwaggerDoc("v1", new OpenApiInfo { Title = "LanguageService", Version = "v1" });
...
builder.Services.AddScoped<ILanguageSectionRepository, LanguageSectionRepository>();
